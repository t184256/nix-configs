...
let
  ...
  tps32k = {  # benchmarked at 32k context
    ...
    "qwen3.8-27b" = { input_tps = 1100; output_tps = 30; };  # plum
  ...
  models = {
    ...
    "qwen3.8-27b-nothink" = mkQwenPlum;
    "qwen3.8-27b-think" = mkQwenPlum;
...
in
{
  ...
  programs.aider-chat = {
    ...
    settings = {
      ...
      editor-model = "qwen3.8-27b-nothink";
      weak-model = "qwen3.8-27b-nothink";
