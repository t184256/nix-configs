...

{
  ...
  accounts.email.accounts."monk@unboiled.info" = {
  ...
  home.file.".mailcap".text = "text/html;  w3m -dump -o document_charset=%{charset} '%s'; nametemplate=%s.html; copiousoutput";
  home.activation.notmuch-symlink = lib.hm.dag.entryAfter ["writeBoundary"] ''
